...
This project demonstrates full-stack development with role-based access control, REST APIs, and cloud integration. ☁️💻
...
Manage products and banners (CRUD operations) 🖼️
View orders and track revenue 💰
Full administrative control of the platform 🛠️
...
MongoDB & Mongoose – NoSQL database with schema modeling 🗄️
...
Nodemailer – Email notifications for users and admins ✉️
Multer + Cloudinary – File uploads and cloud storage for product images and banners ☁️📸
Bcrypt.js – Password hashing for secure authentication 🔒
Cors & Helmet – Security and cross-origin support 🛡️
